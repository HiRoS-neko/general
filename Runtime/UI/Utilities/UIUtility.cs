...
namespace Devdog.General.UI
{
    ...
    {
        private static readonly Dictionary<Type, MethodInfo> _reflectionCache = new();
        ...
        public static bool isHoveringUIElement
        {
            get
            {
                if (EventSystem.current == null || EventSystem.current.currentInputModule == null) return false;
                ...
                if (methodInfo == null)
                {
                    methodInfo = inputModuleType.GetMethod("GetLastPointerEventData",
                ...
                var eventData = (PointerEventData)methodInfo.Invoke(EventSystem.current.currentInputModule,

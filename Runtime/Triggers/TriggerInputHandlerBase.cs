...
{
    public abstract class TriggerInputHandlerBase : MonoBehaviour, ITriggerInputHandler, IPointerEnterHandler,
...
//        protected static CursorIcon cursorIconBefore;
        ...
        {
            if (TriggerUtility.mouseOnTrigger == trigger) TriggerUtility.mouseOnTrigger = null;

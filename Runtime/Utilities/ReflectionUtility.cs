...
namespace Devdog.General
{
    public static class ReflectionUtility
    {
        ...
        {
            if (startType == typeof(MonoBehaviour) || startType == null || startType == typeof(object)) return;
        ...
        public static FieldInfo GetFieldInherited(Type startType, string fieldName)
        {
            ...
            var field = startType.GetField(fieldName,
...
//            }
            ...
            if (creatableTypesOnly) types = types.Where(o => o.IsAbstract == false && o.IsInterface == false).ToList();

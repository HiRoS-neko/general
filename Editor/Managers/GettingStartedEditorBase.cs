...
namespace Devdog.General.Editors
{
    public abstract class GettingStartedEditorBase : EditorWindow
    {
        ...
        private const string IconRootPath = "Packages/io.devdog.general/Editor/EditorStyles/";
        ...
        public string editorPrefsKey => "SHOW_" + productName + "_GETTING_STARTED_WINDOW" + version;
        ...
        protected void OnGUI()
        {
            ...
            GUILayout.BeginArea(new Rect(SingleColWidth + SingleColWidth / 50, 0, SingleColWidth + 10,
        ...
        protected void DrawMailSignupForm()
        {
            ...
            EditorGUILayout.LabelField("Join 16k+ game devs on the Devdog newsletter.",
        ...
        {
            var toggle = GUI.Toggle(new Rect(10, window.position.height - 20, SingleColWidth - 10, 20), showOnStart,
                "Show " + productName + " getting started on start.");
        ...
        protected void DrawBox(int index, int extraHeight, string title, string desc, Texture texture, Action action)
        {
            ...
            const int offset = 30;
            var offsetY = offset + spacing * index + 64 * index;
            ...
            if (GUI.Button(rect, GUIContent.none, GUIStyle.none)) action();

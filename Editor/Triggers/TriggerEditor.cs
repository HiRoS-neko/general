...
namespace Devdog.General.Editors
{
    ...
    public class TriggerEditor : Editor
    {
        ...
        public virtual void OnEnable()
        {
            ...
            _inputHandlers.description =
                "Add an input handler to trigger this trigger with a key press, button press, etc";
            _inputHandlers.allowMultipleImplementations = false;

            var rangeHandlerTarget = t.transform.Find("_RangeHandler");
            if (rangeHandlerTarget == null) rangeHandlerTarget = t.transform;
        ...
        public void OnSceneGUI()
        {
            ...
            if (trigger.rangeHandler != null && trigger.rangeHandler.Equals(null) == false) return;

            var discColor = _outOfRangeColor;
            if (Application.isPlaying && trigger.inRange) discColor = _inRangeColor;
            ...
            if (GeneralSettingsManager.instance != null && GeneralSettingsManager.instance.settings != null)
            {
                ...
                Handles.CircleHandleCap(0, trigger.transform.position, Quaternion.Euler(euler), useRange,
                    EventType.Repaint);
#else
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawPropertiesExcluding(serializedObject, "_window", script.name);

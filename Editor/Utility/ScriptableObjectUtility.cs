...
namespace Devdog.General.Editors
{
    public static class ScriptableObjectUtility
    {
        ...
        public static ScriptableObject CreateAsset(Type type, string savePath, string fileName, bool saveAndRefresh)
        {
            ...
            if (fileName.EndsWith(".asset") == false) fileName += ".asset";
        ...
        {
            var path = UnityEditor.EditorUtility.SaveFilePanelInProject("Save file", defaultFileName, "asset",
                "Choose a location where to save.");
            ...
            if (string.IsNullOrEmpty(path) == false) return CreateAsset<T>(path, defaultFileName, saveAndRefresh);

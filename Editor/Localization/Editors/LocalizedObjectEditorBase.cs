        ...
        where T : Object
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            if (LocalizationManager.currentDatabase != null &&
                LocalizationManager.currentDatabase.ContainsObject(keyField.stringValue) == false)
            ...
            if (EditorGUI.EndChangeCheck() && LocalizationManager.defaultDatabase != null)
            {
                if (obj != LocalizationManager.defaultDatabase.GetObject<T>(keyField.stringValue))
                    if (IsNullOrWhiteSpace(keyField.stringValue) ||
                        ...
                        keyField.stringValue = LocalizationManager.CreateNewObjectKey(obj);
        ...
        {
            var constructor = typeof(T3).GetConstructor(new[] { typeof(string) });

    ...
    public class LocalizedStringEditor : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            if (_textArea != null)
            {
                ...
                LocalizationEditorUtility.DrawLanguagePicker(ref rect, keyField.stringValue,
                    newKeyName => { keyField.stringValue = newKeyName; });
                ...
                if (LocalizationManager.currentDatabase != null &&
                    LocalizationManager.currentDatabase.ContainsString(keyField.stringValue) == false)
                ...
                if (EditorGUI.EndChangeCheck() && LocalizationManager.defaultDatabase != null &&
                    str2 != LocalizationManager.defaultDatabase.GetString(keyField.stringValue))
                {
                    if (IsNullOrWhiteSpace(keyField.stringValue) ||
                        keyField.stringValue == LocalizationManager.NoKeyConstant)
            ...
            if (EditorGUI.EndChangeCheck() && LocalizationManager.defaultDatabase != null &&
                str != LocalizationManager.defaultDatabase.GetString(keyField.stringValue))
            {
                if (IsNullOrWhiteSpace(keyField.stringValue) ||
                    keyField.stringValue == LocalizationManager.NoKeyConstant)
                    keyField.stringValue = LocalizationManager.CreateNewStringKey();

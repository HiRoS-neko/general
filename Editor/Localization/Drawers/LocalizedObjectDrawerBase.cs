...
namespace Devdog.General.Localization.Editors
{
        ...
        where T2 : ILocalizedObject
    {
        ...
        public override bool isEmpty => ((T2)value).objectVal == null;
        ...
        protected override object DrawInternal(Rect rect)
        {
            ...
            if (LocalizationManager.currentDatabase != null &&
                LocalizationManager.currentDatabase.ContainsObject(keyName) == false)
            ...
            if (EditorGUI.EndChangeCheck() && LocalizationManager.defaultDatabase != null &&
                obj != LocalizationManager.defaultDatabase.GetObject<T>(keyName))
            {
        ...
        private void Update()
        {
            ...
            if (typeof(T).IsAssignableFrom(fieldType) &&

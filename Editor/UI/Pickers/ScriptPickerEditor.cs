...
namespace Devdog.General.Editors
{
    public class ScriptPickerEditor : GenericObjectPickerBaseEditor<Type>
    {
        ...
        private static Type[] _ignoreTypes = Type.EmptyTypes;
        ...
        {
            return ReflectionUtility.GetAllTypesThatImplement(_type, true).Where(o => _ignoreTypes.Contains(o) == false)
                .ToList();
        }
        ...
        {
            if (GUILayout.Button(item.Name)) NotifyPickedObject(item);
        }
    }
}
...
namespace Devdog.General.Editors
{
    public static class EditorStyles
    {
        ...
        public static float labelWidth => 200.0f;
        ...
        public static string SearchBar(string searchQuery, EditorWindow window, bool isSearching)
        {
            ...
            var q = EditorGUILayout.TextField(searchQuery, (GUIStyle)"SearchTextField"); // , GUILayout.Width(width)
            if (isSearching)
            {
                if (GUILayout.Button("", "SearchCancelButton", GUILayout.Width(17)))
                {
                    q = ""; // Reset
                    if (window != null)
                        window.Repaint();
            ...
            {
                GUILayout.Button("", "SearchCancelButtonEmpty", GUILayout.Width(17));
            }
        ...
        public static string SearchBar(Rect rect, string searchQuery, EditorWindow window, bool isSearching)
        {
            ...
            var q = EditorGUI.TextField(searchFieldRect, searchQuery, (GUIStyle)"SearchTextField");

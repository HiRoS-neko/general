...
namespace Devdog.General.Editors.ReflectionDrawers
{
    ...
    public class AssetDrawer : ChildrenValueDrawerBase
    {
        ...
        {
            foreach (var child in children) child.required = required;
        }
        ...
        public override GUIContent overrideFieldName
        {
            set
            {
                foreach (var child in children) child.overrideFieldName = value;
            }
        }
        ...
        protected virtual void DrawArrayControls(ref Rect rect)
        {
            ...
            {
                if (drawer.overrideFieldName == null) drawer.overrideFieldName = new GUIContent(fieldName);
